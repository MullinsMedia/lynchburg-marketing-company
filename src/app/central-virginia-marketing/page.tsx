...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description:
      'Mullins Media Co. is the marketing company central Virginia businesses trust for SEO, Google Ads, social media, website design, TV, and more. Founded 2013. Call (434) 204-4226.',
    alternates: {
